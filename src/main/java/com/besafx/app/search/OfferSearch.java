...
public class OfferSearch {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(OfferSearch.class);
    ...
    public Page<Offer> filter(
        ...
        List<Specification<Offer>> predicates = new ArrayList<>();
        //Offer Specification
        ...
        if (!predicates.isEmpty()) {
            ...
            return offerService.findAll(pageRequest);
        }
    }
}
