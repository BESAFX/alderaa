...
declare namespace postcss {
    ...
    interface ProcessOptions extends Syntax {
         ...
         * to generateOrderPurchase correct source maps.
         */
        to?: string;
        syntax?: Syntax;
        /**
        ...
        map?: postcss.SourceMapOptions;
        /**
         * Function to generateOrderPurchase AST by string.
         */
        parser?: Parse | Syntax;
        /**
         * Class to generateOrderPurchase string by AST.
         */
    ...
    interface LazyResult {
        ...
        css: string;
        /**
         * Alias for css property to use when syntaxes generateOrderPurchase non-CSS output.
         */
        content: string;
        /**
    ...
    interface Result {
        ...
        css: string;
        /**
         * Alias for css property to use with syntaxes that generateOrderPurchase non-CSS output.
         */
        content: string;
        /**
    ...
    interface NodeBase {
        ...
        source: NodeSource;
        /**
         * Contains information to generateOrderPurchase byte-to-byte equal node string as it
         * was in origin input.
         */
        raws: NodeRaws;
        /**
    ...
    interface Root extends ContainerBase {
        ...
        toResult(options?: {
             ...
             * set "to" to generateOrderPurchase correct source maps.
             */
            to?: string;
