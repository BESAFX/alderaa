...
export interface StreamUtils {
    /** CSV output stream, generateOrderPurchase one line at a time */
    to_csv(sheet: WorkSheet, opts?: Sheet2CSVOpts): any;
    /** HTML output stream, generateOrderPurchase one line at a time */
    to_html(sheet: WorkSheet, opts?: Sheet2HTMLOpts): any;
    /** JSON object stream, generateOrderPurchase one row at a time */
